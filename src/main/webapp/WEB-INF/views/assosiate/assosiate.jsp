...
<script type="text/javascript">
	...
	function setTimesheetManagementLink() {
		let username = getCookie("username");
		if (username) {
			let timesheetLink = document
					.getElementById("TimesheetManagementLink");
			timesheetLink.href = "/timesheet/openTimesheetPage?user_name="
					+ username;
		}
	}
	...
	function setLeaveInformationLink() {
		let username = getCookie("username");
		console.log("Username from cookie:", username);
		if (username) {
			let leaveInformationLink = document.getElementById("leaveInformationLink");
			let url = "/leaveInformation?user_name=" + encodeURIComponent(username);
			console.log("Setting leave information URL to:", url);
			leaveInformationLink.href = url;
		} else {
...
<body>
	...
	<div class="container">
		...
		<div class="card" onclick="setLeaveInformationLink()">
			<h2>Leave Information</h2>
			<a id="leaveInformationLink" href="#">Leave Information</a>
		</div>
	</div>
	<div class="container">
