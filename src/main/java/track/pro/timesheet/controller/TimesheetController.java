...
public class TimesheetController {
	...
	public String fillTimesheet(@RequestParam("user_name") String username, @RequestParam("task_id") int taskId,
	                            @RequestParam("date") String date, @RequestParam("hours_logged") Double hoursLogged, Model model) {
	    int userId = timesheetService.getUserIdByUsername(username);
	    ...
	    return "redirect:/timesheet/openTimesheetPage?user_name=" + username + "&success=true";
	}
